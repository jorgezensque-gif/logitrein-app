...
# ══════════════════════════════════════════════
    ...
    # Tenta logitrein_final.html (minificado 277KB→72KB gzip) ou o original
    for candidate in ['logitrein_final.html', 'logitrein.html', 'logitrein_v12_integrado.html']:
    ...
    if html_content:
        ...
        st.error("Arquivo logitrein não encontrado.")
# ══════════════════════════════════════════════
